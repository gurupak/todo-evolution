      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              AI-powered task management that understands you. Manage tasks
              effortlessly with natural conversation.
            </p>
            {/* Social Links - FR-032, FR-035 */}
          ...
          {/* Footer Navigation Links - FR-031 */}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-400 text-sm">
            © {currentYear} Todo-Evolution. All rights reserved.
          </p>

          {/* Attribution - FR-034 */}
          <p className="text-gray-400 text-sm mt-4 md:mt-0">
            Built by Todo-Evolution Team
          </p>
        </div>
      </div>
    </footer>
